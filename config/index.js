...
module.exports = {
  dev: {
    ...
    proxyTable: {
      ...
      '/v1/mtp': {
        target: require('./dev.env').api.manaement.menu,
        logLevel: 'debug',
        changeOrigin: true
      },
      '/v1/oss/object': {
      ...
      '/v1/search/push': {
        target: require('./dev.env').api.search.push,
        changeOrigin: true
      },
      '/v1/search/docq': {
        target: require('./dev.env').api.search.search,
        changeOrigin: true
      },
      '/v1/dbcache':{
      ...
      '/v1/image/service':{
        target:require('./dev.env').api.image.host,
        changeOrigin: true
      },
      '/v1/mtp':{
  ...
  prod: {
    ...
    index: path.resolve(__dirname, '../mcloud/index.html'),
    assetsRoot: path.resolve(__dirname, '../mcloud'),
    assetsSubDirectory: 'static',
    assetsPublicPath: '../',
