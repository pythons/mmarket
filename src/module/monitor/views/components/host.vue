          ...
          <el-row>
            <a style="color: #20a0ff" >
              <el-button class="button is-info pull-left" @click="viewRules">
                查看报警规则</el-button></a>
            <el-button style="width: 138px;margin: 0 0 0 10px" class="pull-left">
              <el-dropdown @command="exReport" type="primary" style="width: 120px">
            ...
            <el-button @click="loading" class="glyphicon glyphicon-refresh pull-left" title="刷新">刷新</el-button>
            <!--<el-select  filterable placeholder="导出报表" size="8" v-model="report" @change="exReport">
              <el-option :label='item.label' :value='item.value' v-for="item in reportData"></el-option>
            </el-select>-->
