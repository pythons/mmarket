  ...
  <paper>
    ...
    <el-form :inline="true" label-width="80px">
      ...
      <el-form-item class="item-title" label="应用管理员">
        <el-input readonly v-model="adminMsg.managerId"></el-input>
      </el-form-item>
      <el-form-item class="item-title" label="系统管理员" style="margin-left:12%">
        <el-input readonly v-model="adminMsg.systemManagerId"></el-input>
      </el-form-item>
    </el-form>
    ...
    <div style="text-align: center;right;margin: 30px 0 20px 0;">
      ...
      <el-button type="primary" @click="submitApplyFun">申请</el-button>
    </div>
  </paper>
</template>
<script>
